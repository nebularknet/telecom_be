...
const mccMncDataSchema = new mongoose.Schema(
  ...
  { _id: false },
); // _id: false prevents Mongoose from creating a default _id for this subdocument
...
const phoneNumberValidationSchema = new mongoose.Schema(
  {
    ...
    Carrier: {
      ...
      type: String,
      description:
        'The carrier or brand name obtained from MCC-MNC data (e.g., Zong).',
      default: null,
    },
    Type: {
      // Matches veriphone.io
    ...
    'Int. number': {
      ...
      type: String,
      description:
        'The phone number in international format (e.g., +92 316 5290267).',
      default: null,
    },
    'Local number': {
      // Matches veriphone.io
    ...
    'E164 number': {
      ...
      default: null,
      index: true, // Added index for E164 number
    },
    Region: {
      // Matches veriphone.io
      type: String,
      description:
        'The region associated with the phone number (often the same as Country).',
      default: null,
    },
    'Dial code': {
      // Matches veriphone.io
  ...
  { timestamps: true },
); // Added timestamps for created and updated times

const PhoneNumberValidation = mongoose.model(
